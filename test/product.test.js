...
describe('Product Controller', () => {
  ...
  describe('getProducts', () => {
    ...
    it('should filter products by category', async () => {
      ...
      const mockProducts = [
        { _id: 'prod1', title: 'Product 1', categories: ['cat123'] },
      ]
      const mockQuery = {
        sort: sinon.stub().returnsThis(),
        skip: sinon.stub().returnsThis(),
  ...
  describe('createProduct', () => {
    ...
    it('should create a product with images', async () => {
      ...
      sinon.stub(Products, 'findOne').resolves(null)
      sinon
        .stub(ImageService, 'processMultipleImages')
        .resolves(mockProcessedImages)
      sinon.stub(Category, 'find').resolves(mockCategories)
      sinon.stub(Products, 'create').resolves(mockProduct)
      sinon.stub(NotificationEmitter, 'emit')
  ...
  describe('editProduct', () => {
    ...
    it('should update product with new images and delete old ones', async () => {
      ...
      req.files = [
        { originalname: 'newimage.jpg', buffer: Buffer.from('test') },
      ]

      const oldImages = [
        {
          original: {
            url: '/uploads/products/original/old1.jpg',
            filename: 'old1.jpg',
          },
        },
      ]
      ...
      const newProcessedImages = [
        {
          original: {
            url: '/uploads/products/original/newimage.jpg',
